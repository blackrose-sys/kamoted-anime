...
export function Hero({ featured }: HeroProps) {
  ...
  return (
    <div className="hero-wrapper" style={{ position: 'relative', width: '100%', minHeight: '60vh', display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
      ...
      <div className="container" style={{ paddingTop: '80px', paddingBottom: '80px', position: 'relative', zIndex: 10 }}>
        <div className="hero-badge" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', backgroundColor: 'rgba(245, 158, 11, 0.1)', border: '1px solid var(--accent-primary)', color: 'var(--accent-primary)', padding: '0.25rem 0.75rem', borderRadius: '9999px', fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.05em', marginBottom: '1rem', textTransform: 'uppercase' }}>
          <span>Featured #{currentIndex + 1}</span>
        </div>
        
        <h1 className="hero-title line-clamp-2" style={{ fontSize: '2.5rem', fontWeight: 900, letterSpacing: '-0.02em', lineHeight: 1.1, marginBottom: '1rem', maxWidth: '800px', textShadow: '0 4px 12px rgba(0,0,0,0.5)' }}>
          {currentAnime.title}
        </h1>
        
        <p className="hero-synopsis" style={{ color: 'var(--text-secondary)', fontSize: '1rem', maxWidth: '600px', marginBottom: '2rem', lineHeight: 1.6, textShadow: '0 2px 8px rgba(0,0,0,0.8)' }}>
        ...
        {/* Indicators */}
        <div className="hero-indicators" style={{ position: 'absolute', bottom: '20px', right: '20px', display: 'flex', gap: '0.5rem' }}>
